...
class CreaseCheckerEngine:
    ...
    def check_front_foot_crease(self, front_toe_y_m: float) -> Tuple[bool, float]:
    ...
    def check_wide_tramline(self, ball_x_m: float, batter_stance_rhb: bool = True) -> Tuple[bool, Optional[str]]:
